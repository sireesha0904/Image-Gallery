...
- Use the forward (`>`), backward (`<`), and close (`X`) buttons in the lightbox to navigate or close the lightbox.
- Click the download button to save the image to your disk.
- Use the sun/moon icon to toggle between light and dark modes.
